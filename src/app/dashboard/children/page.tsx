      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <input id="search-input" type="text" className="hidden" />
          ...
          {/* Rango de edad */}
          <div className="space-y-2">
            <label htmlFor='search-input' className="text-sm font-medium">Edad máxima</label>
            <input id="search-input" type="text" className="hidden" />
            <Input
              type="number"
              placeholder="Años"
...
export default function ChildrenPage() {
  ...
  // Componente para cuando no hay niños
  ...
  // Componente para cuando no hay resultados filtrados
  ...
  const renderMainContent = () => {
    ...
    if (filteredChildren.length === 0) return <NoFilteredResultsState />;
